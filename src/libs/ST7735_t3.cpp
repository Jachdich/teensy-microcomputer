...
bool ST7735_t3::commonInit(const uint8_t *cmdList, uint8_t mode)
{
	...
	if (_pspi) {
		...
		_pspi->begin();
		_pending_rx_count = 0;
		_spiSettings = SPISettings(60000000, MSBFIRST, mode);
	...
	_spiSettings = SPISettings(32000000, MSBFIRST, mode);
